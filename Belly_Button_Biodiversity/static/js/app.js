function buildMetadata(sample) {
  ...
  d3.json(metadatURL).then(function (data){
    ...
    rotation: 90,
    text: ['8-9x','7-8x','6-7x','5-6x', '4-5x', '3-4x', '2-3x',
              '1-2x', '0-1x', ''],
    textinfo: 'text',
    textposition:'inside',
    ...
    labels: ['8-9x','7-8x','6-7x','5-6x', '4-5x', '3-4x', '2-3x',
    '1-2x', '0-1x', ''],
    hoverinfo: 'label',
    hole: .5,
    type: 'pie',
...
function buildCharts(sample) {
  ...
  Plotly.newPlot('bubble', trace1, layout);
    var data = [{
      ...
      hovertext: data.otu_ids.slice(0,10),
      type: 'pie',
    }];
    var layout = {
      showlegend: true,
